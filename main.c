...
int main(){
    ...
    /*Tant que le nombre entier choisi par l'utilisateur ne correspond pas au nombre entier choisi par l'ordinateur on rentre dans les conditions de la boucle while.*/
